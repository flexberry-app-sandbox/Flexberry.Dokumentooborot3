...
namespace IIS.Dokumentooborot3
{
    ...
    public class ТЧПрава : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dokumentooborot3.ПраваПол fПраваПол;
        ...
        public virtual IIS.Dokumentooborot3.ПраваПол ПраваПол
        {
            get
            {
                ...
                IIS.Dokumentooborot3.ПраваПол result = this.fПраваПол;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Dokumentooborot3.АвПользователи.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПраваE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПраваE", typeof(IIS.Dokumentooborot3.ТЧПрава));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПрава : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Dokumentooborot3.DetailArrayOfТЧПрава members)

        // *** End programmer edit section *** (IIS.Dokumentooborot3.DetailArrayOfТЧПрава members)
        ...
        /// </summary>
        public DetailArrayOfТЧПрава(IIS.Dokumentooborot3.АвПользователи fАвПользователи) : 
                base(typeof(ТЧПрава), ((ICSSoft.STORMNET.DataObject)(fАвПользователи)))
        {
        }
        
        public IIS.Dokumentooborot3.ТЧПрава this[int index]
        {
            get
            {
                return ((IIS.Dokumentooborot3.ТЧПрава)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Dokumentooborot3.ТЧПрава dataobject)
        {
