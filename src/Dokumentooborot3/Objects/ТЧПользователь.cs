...
namespace IIS.Dokumentooborot3
{
    ...
    public class ТЧПользователь : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dokumentooborot3.АвПользователи fАвПользователи;
        
        private IIS.Dokumentooborot3.ВходВСистему fВходВСистему;
        ...
        [PropertyStorage(new string[] {
                "АвПользователи"})]
        [NotNull()]
        public virtual IIS.Dokumentooborot3.АвПользователи АвПользователи
        {
            get
            {
                ...
                IIS.Dokumentooborot3.АвПользователи result = this.fАвПользователи;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Dokumentooborot3.ВходВСистему.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ВходВСистему"})]
        public virtual IIS.Dokumentooborot3.ВходВСистему ВходВСистему
        {
            get
            {
                ...
                IIS.Dokumentooborot3.ВходВСистему result = this.fВходВСистему;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПользовательE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПользовательE", typeof(IIS.Dokumentooborot3.ТЧПользователь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПользователь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Dokumentooborot3.DetailArrayOfТЧПользователь members)

        // *** End programmer edit section *** (IIS.Dokumentooborot3.DetailArrayOfТЧПользователь members)
        ...
        /// </summary>
        public DetailArrayOfТЧПользователь(IIS.Dokumentooborot3.ВходВСистему fВходВСистему) : 
                base(typeof(ТЧПользователь), ((ICSSoft.STORMNET.DataObject)(fВходВСистему)))
        {
        }
        
        public IIS.Dokumentooborot3.ТЧПользователь this[int index]
        {
            get
            {
                return ((IIS.Dokumentooborot3.ТЧПользователь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Dokumentooborot3.ТЧПользователь dataobject)
        {
